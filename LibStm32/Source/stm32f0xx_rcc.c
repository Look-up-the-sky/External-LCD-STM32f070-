...
@endverbatim
  * @{
  */
void sSetAPBAHBPrescTable(void)
{
	APBAHBPrescTable[0] = 0;
	APBAHBPrescTable[1] = 0;
	APBAHBPrescTable[2] = 0;
	APBAHBPrescTable[3] = 0;
	APBAHBPrescTable[4] = 1;
	APBAHBPrescTable[5] = 2;
	APBAHBPrescTable[6] = 3;
	APBAHBPrescTable[7] = 4;
	APBAHBPrescTable[8] = 1;
	APBAHBPrescTable[9] = 2;
	APBAHBPrescTable[10] = 3;
	APBAHBPrescTable[11] = 4;
	APBAHBPrescTable[12] = 6;
	APBAHBPrescTable[13] = 7;
	APBAHBPrescTable[14] = 8;
	APBAHBPrescTable[15] = 9;
}
